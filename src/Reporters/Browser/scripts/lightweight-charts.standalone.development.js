    ...
    ***************************************************************************** */
    ...
    var PaneRendererArea = /** @class */ (function () {
        ...
        PaneRendererArea.prototype.draw = function (ctx) {
            ...
            var baseline = Math.min(this._data.bottom, this._data.zeroLine);
            ctx.save();
            ctx.lineCap = 'square';
    ...
    var LinePaneViewBase = /** @class */ (function (_super) {
        ...
        function LinePaneViewBase(series, model) {
            var _this = _super.call(this, series, model, true) || this;
            _this._itemsZeroLine = NaN;
            return _this;
        }
    ...
    var PriceScale = /** @class */ (function () {
        ...
        PriceScale.prototype.pointsArrayToCoordinates = function (points, baseValue, visibleRange) {
            ...
            var getPoint = function (price) {
                var logical = price;
                if (transformFn !== null) {
                    logical = transformFn(price, baseValue);
                }
                var invCoordinate = bh + hmm * (logical - min);
                var coordinate = isInverted ? invCoordinate : _this._private__height - 1 - invCoordinate;
    ...
    var TickMarks = /** @class */ (function () {
        ...
        TickMarks.prototype.nearestIndex = function (time) {
            ...
            var average = ((ensureDefined(this._private__marksByIndex.get(left)).time.timestamp * 1000) + ensureDefined(this._private__marksByIndex.get(right)).time.timestamp * 1000) / 2;
            if (time > average) {
                return right;
            }
            else {
    ...
    var TimeScale = /** @class */ (function () {
        ...
        TimeScale.prototype.timeToCoordinate = function (time) {
            if (this.isEmpty() || !isInteger(time)) {
                return 0;
            }
            var index = this._private__tickMarks.nearestIndex(time);
    ...
    var PaneWidget = /** @class */ (function () {
        function PaneWidget(chart, state) {
            ...
            this._private__paneId = PaneWidget.PANE_COUNTER++;
            PaneWidget.PANE_MAP.set(this._private__paneId, this);
        ...
        PaneWidget.prototype.destroy = function () {
            ...
            PaneWidget.PANE_MAP.delete(this._private__paneId);
            this._private__mouseEventHandler.destroy();
        };
        ...
        PaneWidget.prototype.mouseMoveEvent = function (event) {
            ...
            if (!mobileTouch) {
                ...
                this._private__syncCrosshair(x);
            }
        };
        ...
        PaneWidget.prototype.setCrosshairPositionByTime = function (time) {
            var coordinate = this._private__model().timeScale().timeToCoordinate(time * 1000);
            this._private__setCrosshairPosition(coordinate, 0);
        };
        PaneWidget.prototype._private__syncCrosshair = function (x) {
            var _this = this;
            if (x !== undefined) {
                var index = this._private__model().timeScale().coordinateToIndex(x);
                var time_1 = this._private__model().timeScale().indexToUserTime(index);
                if (time_1) {
                    PaneWidget.PANE_MAP.forEach(function (pane, id) {
                        if (_this._private__paneId !== id) {
                            pane.setCrosshairPositionByTime(time_1.timestamp);
                        }
                    });
                }
            }
                ...
                PaneWidget.PANE_MAP.forEach(function (pane, id) {
                    if (_this._private__paneId !== id) {
                        pane._private__clearCrosshairPosition();
                    }
                });
            }
        };
        ...
        PaneWidget.PANE_COUNTER = 0;
        PaneWidget.PANE_MAP = new Map();
        return PaneWidget;
    }());
